...
def main ():
    ...
    # Start generating 
    generate_bleu(model, dev_dataloader, accelerator, tokenizer, output_dir, 'dev')
    generate_bleu(model, test_dataloader, accelerator, tokenizer, output_dir, 'test')
...
'''
accelerate launch --num_machines=1 --num_processes=1 --machine_rank=0 --main_process_ip=127.0.0.1 --main_process_port=9999 --same_network spaemo_generate.py config=configs/SpaEMo_P14_config.yaml --experiment.project="SpaEMo_P14" --experiment.name="SpaEMo_P14_run1" --experiment.output_dir="SpaEMo_P14_run1"
'''
